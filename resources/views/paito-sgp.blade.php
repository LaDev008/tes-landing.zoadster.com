			...
			class="cari form-control form-control-sm text-center" type="text" id="asc" style="background:#FFF;"
			autocomplete="off"></div>
			<div class="col-2 px-1"><input maxlength="1" placeholder="kop"
			class="cari form-control form-control-sm text-center" type="text" id="kopc" style="background:#FFF;"
			autocomplete="off"></div>
			...
			<div id="data-sgp">
			<?php
			$konten = file_get_contents('https://w3.angkanet.tv/paito-warna-singapore/');
